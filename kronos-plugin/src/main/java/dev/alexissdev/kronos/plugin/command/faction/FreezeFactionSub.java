...
@Singleton
public class FreezeFactionSub extends FactionSubCommand {
    ...
    @Inject
    public FreezeFactionSub(FactionService factionService, MessagesConfig messages, Plugin plugin) {
        ...
        factionService.getByName(factionName).thenCompose(opt -> {
            ...
            return factionService.freezeFaction(faction.getId(), player.getUniqueId())
                    .thenRun(() -> Bukkit.getScheduler().runTask(plugin, () -> {
                        ...
                        notifyMembers(faction, messages.get("faction.frozen-self"));
                    }));
