...
@Singleton
public class OverclaimFactionSub extends FactionSubCommand {
    ...
    @Inject
    public OverclaimFactionSub(FactionService factionService, ClaimService claimService,
    ...
    @Override public String name() { return "overclaim"; }
